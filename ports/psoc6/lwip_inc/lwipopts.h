#ifndef MICROPY_INCLUDED_PSOC6_LWIP_LWIPOPTS_H
#define MICROPY_INCLUDED_PSOC6_LWIP_LWIPOPTS_H
...
// extern uint32_t cyhal_random(void);
#define LWIP_RAND() (42) // To implement in terms of cy_hal
...
#endif // MICROPY_INCLUDED_PSOC6_LWIP_LWIPOPTS_H
